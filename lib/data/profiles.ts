...
export const profiles: Profile[] = [
  {
    ...
    classYear: "'65",
    quote:
      '"For me, Pomfret was a dream come true; it provided an opportunity for an excellent education but more importantly, a chance to demonstrate that students committed to exercising mutual respect for each other, regardless of their race, could live, study, and play together."',
    bio:
  ...
  },
  {
    ...
    bio:
      "Ugandan-born student and the first Black student to take a diploma on the Hilltop, preceding John Irick by half a decade. Attended Pomfret for one year. At graduation, Mwine presented Pomfret with a traditional African spear. His legacy lived on in a display outside Headmaster Brad Hastings's office.",
  ...
  },
  {
    ...
    bio:
      'Daughter of beloved Pomfret headmaster Bronson Strong, Joan became the first female student in the classroom at Pomfret. Her parents asked the board of trustees if she could attend Main House (eighth grade), and she then continued for the second form. Later earned a B.A. in Music from Smith College, M.A. in Psychology from Wheaton, and attended Portland State. Retired teacher and hospice administrator.',
  ...
  },
  {
    ...
    classYear: "'60",
    quote:
      '"Being at Pomfret taught me that if I could be heard, understood and accepted in such a tough, challenging, and male environment, I was really my whole life, and that second form created another dimension. Many people in the class of \'60 are still professional and personal friends."',
    bio:
      'Daughter of Pomfret dean Dolph Downing. Attended for the sixth form (senior year), 1959-1960. One of a handful of Pomfret daughters allowed to attend classes. Later earned a B.A. in English from Wheaton College. Community volunteer and artist in Worcester, Massachusetts.',
  ...
  },
  {
    ...
    classYear: "'74",
    quote:
      '"I didn\'t have the sense that there was hostility or unhappiness; just a very normal, understandable resistance to change."',
    bio:
      "Daughter of headmaster Jay Milnor. Credited with helping introduce the first true organized sport for girls at Pomfret — soccer — in the fall of '68 upon her freshman arrival. The team was coached by Hagop Merjian (Pomfret faculty 1961-1999) who would become a legendary mentor. Later earned a B.A. Social Psychology (Tufts), M.A. Social Work (Simmons). Psychotherapist in an all-women private group practice.",
  ...
  },
  {
    ...
    classYear: "'74",
    quote:
      '"I never considered myself to be the first female Editor-in-Chief of The Pontefract, but no one was going to be up-set if you realized it wasn\'t your thing. I was a left-footed, slightly tone deaf farm girl when I arrived at Pomfret, but I had the lead in musicals and played soccer."',
    bio:
      'First female Editor-in-Chief of The Pontefract, editing the November 4, 1972 article titled "The Integration of Coeducation." Earned degrees from Harvard (A.B., cum laude), University of Reading (Ph.D., \'98), and is now University Academic at Warwick Business School, University of Warwick, Coventry, England.',
  ...
  },
  {
    ...
    classYear: "'77",
    quote:
      '"Having my name on the bowl makes it that much easier for another female athlete to have hers there too. It opens possibilities. It\'s not just winning the award — you feel good about the work leading up to it. That you\'re part of a team, part of something larger than yourself."',
    bio:
      "First female recipient of the Pomfret Bowl, awarded at the Class of 1977 graduation. Presented by Coach Brad Hastings. A standout in girls' basketball, soccer, and girls' crew, and one of eighty-six names before the first female name jumped out. Earned B.A. in Government & Political Science from Bowdoin '81. Litigation Support Supervisor, San Francisco, CA.",
  ...
  },
  {
    ...
    classYear: "'72",
    quote:
      '"Pomfret School was an oasis...a place where I felt I could use all my smarts."',
    bio:
  ...
  },
  {
    ...
    classYear: "'72",
    quote:
      '"Being a resident of Pomfret, I am well acquainted with the fine reputation of Pomfret School. Also, as a Service family, which necessitates frequent relocations, we are well aware of the importance of an environment that will academically challenge our children as well as provide an ambitious scholastic, socially and physically. My husband is expecting an unaccompanied tour of duty this summer."',
    bio:
  ...
  },
  {
    ...
    classYear: "'72",
    quote:
      '"I have to say a special thank you to my English teacher, Don Hinman. I was so thoroughly prepared for college English, I was able to take sophomore English in my freshman year. During that class when my professor asked, \'Who has read such-and-such?\' My hand went up... and went up. I remember feeling like I was so far ahead of the game."',
    bio:
      "Entered Pomfret with precocious sixth form ambitions. Her class includes Andrew '03 and Stephen '05 (her sons). Conference planner for teachers and young scholars in the educational psychology department at UCONN. B.S., Biology, St. Lawrence University '76, Master of Anthropology, University of Wyoming '83.",
    yearsAtPomfret: '1968-1972',
  ...
  },
  {
    ...
    classYear: "'72",
    quote:
      '"It\'s been great to watch Izzie flourish at Pomfret. I love knowing that the Pomfret girls of today feel that the school has always been coed. They don\'t realize that an entirely different atmosphere existed not that long ago. I think it\'s a testament to how far Pomfret School has come in establishing itself as an excellent boarding and day school for girls."',
    bio:
      "Daughter of Pomfret art teacher, crew coach, and long-time legend Chick Cole \"Propeller.\" Beyond being a regular teenager dealing with teenage issues — studying, socializing, establishing friendships, and hoping for acceptance. Created a Cole family legacy when her daughter, Elizabeth \"Izzie\" Butch entered Pomfret in 2001. Later: B.A. Wheaton College '76, M.A. Fairfield University, 2000. Occupation: Marriage and Family Therapist.",
    yearsAtPomfret: '1968-1972',
  ...
  },
  {
    ...
    role: 'Alum',
    classYear: "'72",
    // H8 fix: original quote was from her father Warren, not Eve herself.
    // Replaced with a descriptive tagline drawn from magazine p21.
    quote:
      'Graduated magna cum laude from Brown. Killed by a drunk driver at age 38 while pursuing her M.A. in Social Work at Smith.',
    bio:
      "Class of 1972 (1954-1992). Eldest daughter of Pomfret music teacher Warren Geissinger (faculty 1956-1975) and his wife Barbara, who taught music at Pomfret Community School. Served as an advisor to the early females of Pomfret School from 1968 to 1970. Tragically, Eve was killed by a drunk driver on June 8, 1992, at the age of thirty-eight. Her father graciously agreed to share his recollections. Later: B.A., English, graduated magna cum laude from Brown University '76. State of Connecticut Scholar in 1972. Working on her Master's degree in Social Work at Smith College at the time of her death.",
    yearsAtPomfret: '1968-1972',

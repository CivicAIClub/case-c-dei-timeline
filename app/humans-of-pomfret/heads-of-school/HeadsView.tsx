...
const heads: Head[] = [
  ...
  },
  {
    ...
    years: '1897-1929',
    era: 'founding',
    bio: 'Called from St. Mark\'s, where he had been Senior Master, after a brief faculty-led interim by Pomfret\'s Mr. Boulton in the weeks following Peck\'s death. Peck reportedly consulted the older boys before naming his successor and chose Olmsted to continue the founding work. Olmsted formalized the school\'s name as "Pomfret School" in 1899. Under his thirty-two-year tenure, architect Ernest Flagg designed a campus master plan (1905) and the school grew to include Clark Memorial Chapel, a gymnasium, dormitories, and other facilities. He died on December 10, 1929, after a brief illness.',
  },
  {
    name: 'Halleck Lefferts',
    initials: 'HL',
    years: '1930-1942',
    era: 'early',
    bio: 'Pomfret\'s third Headmaster, called from the Thacher School in California \u2014 where he had taught Dexter Strong, his eventual successor. Lefferts led Pomfret through the Depression and the early years of the Second World War, completing his thirteen-year tenure with the school\'s 1942 graduation. After Pomfret he served as headmaster of Sewickley Academy in Pennsylvania. He died on October 16, 1979.',
  },
  {
  ...
  },
  {
    ...
    years: '1989-1993',
    era: 'modern',
    bio: 'A Williams College graduate (1969) who came to Pomfret from Woodberry Forest School in Virginia, Bassett completed a Kellogg National Fellowship studying gender equity in education before his appointment. He named coeducational leadership his explicit mission \u2014 "to become a leader in the coeducational world" \u2014 and commissioned the 1989-90 "T-Study," a year-long internal review of how Pomfret was serving its female students. Acting on the findings, he appointed Stoney Reed Leonard as the school\'s first Dean of Women, authorized a campus chapter of the Council for Women in Independent Schools (co-chaired by Margie Hueppl and Caroline Twomey), launched the 1991-92 Multicultural Awareness Program under the theme "Unity amidst diversity," and recruited Michael Gary \'82 to return as Director of Multicultural Affairs. After Pomfret he served as president of the Independent Schools Association of the Central States (ISACS) and later of the National Association of Independent Schools (NAIS).',
  },
  {
    ...
    years: '1993-2011',
    era: 'modern',
    bio: 'Born July 1, 1950 in Concord, Massachusetts, and a Pomfret graduate himself (Class of 1968), Hastings was named on December 12, 1992 to succeed Bassett, taking office July 1, 1993. As a young teacher he coached the earliest girls\' ice hockey team (1973) and presented the first Pomfret Bowl to a female recipient, Jessica Birdsall \'77. As Headmaster he oversaw the school\'s 1994 centenary, expanded the DEI infrastructure begun under Bassett \u2014 including the 1995 hire of Michael Gary \'82 as Director of Multicultural Affairs \u2014 and dramatically expanded international programs and financial aid across his eighteen-year tenure.',
  },
  {
  ...
  },
  {
    ...
    imageCredit: 'pomfret.org blog',
    bio: 'Pomfret\'s 13th Head of School and the first woman to hold the position since the school was founded in 1894. Wellesley College graduate with an MS in management. Chairs the NAIS Financial Aid Task Force. Previously associate head at Laurel School in Shaker Heights, Ohio. Formally installed at a ceremony on September 26, 2025.',
  },
];
      ...
      <section className="py-16 lg:py-24 bg-navy">
        <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-cream/70 max-w-2xl font-body leading-relaxed">
            The leaders who shaped Pomfret School from its founding in 1894 to the present,
            sourced from official school archives and the September 2003 &ldquo;Mission Accomplished&rdquo;

...
const fellows: Fellow[] = [
  ...
  },
  {
    ...
    bio: 'Internationally acclaimed author of more than a dozen books including A Short History of Nearly Everything, A Walk in the Woods, and The Mother Tongue. Served as Chancellor of Durham University in England from 2005 to 2011.',
  },
  {
    year: 2006,
    name: 'Brian Greene',
  ...
  },
  {
    ...
    bio: 'Senior fellow at the Watson Institute for International Studies at Brown University and son of former Soviet Premier Nikita Khrushchev (1935\u20132020). His unique perspective on the Cold War and Soviet history made him an exceptionally compelling fellow.',
  },
  {
    year: 2002,
    ...
    <div className="min-h-screen bg-warm-white">
      ...
      <section className="relative py-16 lg:py-24 overflow-hidden bg-cream">
        <div className="relative z-10 max-w-content mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="text-center">
              <div className="font-display text-3xl lg:text-4xl text-maroon">1989</div>
              <div className="text-xs text-slate font-body tracking-wider uppercase mt-1">
                Program Founded
              </div>
            </div>
      ...
      <section className="py-16 border-t border-mist bg-cream">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-xs text-slate/70 font-body leading-relaxed italic border-t border-mist pt-4">
            This list documents the Schwartz Visiting Fellow program as it occurred
            across nearly four decades. Inclusion reflects the historical record of who
            was invited at the time of each visit and is not a contemporary endorsement
            by Pomfret School of any fellow&apos;s personal conduct or public positions
            before or after their time on the Hilltop.
          </p>
        </div>
      </section>
    </div>

...
const demoEvents = [
  ...
  { _id: '12a', title: 'First Foreign Exchange Student via AFS', date: '1975-09-01', category: 'Cultural Events', description: 'Declan Randels, an exchange student from England, arrived at Pomfret through the American Field Service (AFS) program \u2014 the first foreign-exchange student documented at the school. His presence on campus during the 1975-76 academic year added a small but real international dimension to the student body during the financial-survival years.', featured: false },

...
const demoEvents = [
  ...
  { _id: '1c', title: 'Pomfret Incorporates', date: '1898-04-01', category: 'Milestones', description: 'Four years after its founding, Pomfret School was formally incorporated under the laws of Connecticut, with Louis C. Clark elected as its inaugural Trustee President. The first Board of Trustees took the legal and fiduciary form that would govern the school across every generation that followed.', featured: false },
  ...
  { _id: '7c', title: 'First Female Trustee', date: '1970-05-01', category: 'Leadership', description: 'Two years after Pomfret admitted its first female day students, Mrs. Louise M. Warner became the first woman elected to the Board of Trustees. The choice signaled an intention for the school\'s coeducational direction to extend into governance, not only the classroom.', featured: false },
  ...
  { _id: '13b', title: 'First Annual Afro-Latin Day', date: '1981-02-21', category: 'Student Voices', description: 'Junior Michael Gary \'82 organized Pomfret\'s first Afro-Latin Day, with a performance by rock group Julius and the Soul Corruptors. The event extended the work of the 1968 Afro-Latin Society, gave Pomfret\'s minority community a public showcase on campus, and previewed Gary\'s later return to the school in 1995 as its first Director of Multicultural Affairs.', featured: true },
  ...
  { _id: '14b', title: 'Schwartz Visiting Fellows Program Founded', date: '1988-09-01', category: 'Milestones', description: 'Pomfret launched the Schwartz Visiting Fellows program \u2014 endowed by brothers Michael \'66 and Eric \'69 Schwartz to bring an influential figure to campus each year for a week of seminars. The program\'s first fellow was Shirley Chisholm, the first Black woman elected to U.S. Congress and the first African-American woman to run for U.S. Presidency. The series continues today and has hosted more than 35 fellows across fields ranging from civil rights to oceanography to literature.', featured: true },
  { _id: '15', title: 'First Dean of Women Appointed', date: '1989-09-01', category: 'Leadership', description: 'Headmaster Patrick Bassett appointed history teacher Stoney Reed Leonard as the school\'s first Dean of Women, described as "an instigator for raising the consciousness of women\'s issues." Bassett also authorized a campus chapter of the Council for Women in Independent Schools, co-chaired by Margie Hueppl and Caroline Twomey. The appointment followed a New England Association\'s Evaluation Committee report that had explicitly recommended Pomfret "make a strong commitment to appoint more women to high-level administrative positions" \u2014 external pressure that helped spur the change.', featured: false },
  { _id: '15b', title: 'Multicultural Awareness Program: "Unity Amidst Diversity"', date: '1991-09-01', category: 'Milestones', description: 'Headmaster Patrick Bassett launched the Multicultural Awareness Program (MAP) under the school year theme "Unity amidst diversity." Across Bassett\'s tenure, students of color rose from approximately 13% to 18% of enrollment and international students from 3% to 10% \u2014 the first sustained, measurable diversification since the Milnor era reforms of the 1960s.', featured: true },
